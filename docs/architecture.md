...
`Renderer` con registro estático. Convención de nombres: `pages.home` → `views/pages/home.php`.
...
Archivos en `lang/{locale}/general.php`. Helper global `__('general.clave')`.
